...
R&#949;​KiT is a platform jumper game in Java and has an easy-to-understand game engine to understand and modify [AWT](https://docs.oracle.com/javase/8/docs/api/java/awt/package-summary.html).
